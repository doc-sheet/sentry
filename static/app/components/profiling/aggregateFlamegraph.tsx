...
export function AggregateFlamegraph({transaction}: {transaction: string}) {
  const query = useAggregateFlamegraphQuery({transaction});
  return <div>Flamegraph</div>;
}

function useAggregateFlamegraphQuery({transaction}: {transaction: string}) {
